...
function Home() {
  ...
  return (
    <main className="container mx-auto flex flex-col justify-center items-center h-screen 2xl:h-[50rem] relative  overflow-hidden sm:overflow-visible">
      <div
      ...
      {/* Gradient bubbles */}
      <div className="absolute rounded-full top-20 left-0 w-96 h-96 bg-gradient-to-tr from-pink-500 to-yellow-400 mix-blend-multiply filter blur-3xl opacity-70"></div>
